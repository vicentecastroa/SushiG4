...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/sdiez1/Desktop/Taller de Integracion/SushiG4/redis-stable/deps/jemalloc/ /home/sdiez1/Desktop/Taller de Integracion/SushiG4/redis-stable/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/sdiez1/Desktop/Taller de Integracion/SushiG4/redis-stable/deps/jemalloc/ /home/sdiez1/Desktop/Taller de Integracion/SushiG4/redis-stable/deps/jemalloc/
